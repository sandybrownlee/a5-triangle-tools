...
public class LayoutVisitor implements ActualParameterVisitor<Void, DrawingTree>,
	...
	@Override
	public DrawingTree visitLoopWhileCommand(LoopWhileCommand ast, Void unused) {
		//visit the first command block in the loop and generate its drawing tree
		var d1 = ast.C1.visit(this);
		//visit the condition expression in the loop and generate its drawing tree
		var d2 = ast.E.visit(this);
		//visit the second command block in the loop and generate its drawing tree
		var d3 = ast.C2.visit(this);

		//combine the three parts into a ternary layout named LoopWhileCommand
