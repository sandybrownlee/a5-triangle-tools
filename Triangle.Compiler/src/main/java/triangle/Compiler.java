...
public class Compiler {
	 ...
	 *         false.
	 */
	static boolean compileProgram(String sourceName, String objectName, boolean showingAST, boolean folding, boolean stats, boolean showingTable) {
	...
	public static void main(String[] args) {
		...
		var compiledOK = compileProgram(sourceName, objectName, showTree, folding, stats, false);
