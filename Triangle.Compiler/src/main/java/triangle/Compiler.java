...
public class Compiler {
	...
	static String objectName = "obj.tam";
 	@Argument(alias = "tree", description = "Show AST (Abstract Syntax Tree)")
	static boolean showTree = false;
	@Argument(alias = "fold", description = "Perform Folding Optimization")
	static boolean folding = false;
	@Argument(alias = "treeAfterFold", description = "Show AST after folding")
	static boolean showTreeAfterFolding = false;
	@Argument(alias = "stats", description = "Show number of Expressions")
	...
	public static void main(String[] args) {
		...
		if (args.length < 1) {
			System.out.println("Usage: tc filename [-o= outputfilename] [-tree] [-fold] [-treeAfterFold] [-stats]");
			System.exit(1);
		}

		com.sampullara.cli.Args.parse(Compiler.class, args);

		String sourceName = args[0];
		
		var compiledOK = compileProgram(sourceName, objectName, showTree, false,showTreeAfterFolding);
