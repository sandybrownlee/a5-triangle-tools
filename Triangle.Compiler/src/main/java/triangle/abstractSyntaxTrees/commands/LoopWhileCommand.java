...
public class LoopWhileCommand extends Command {
	...
	public final Command C1; // initial command
	public Expression E; // condition evaluated in the middle of loop
	public final Command C2; // command runs if condition is true
}
