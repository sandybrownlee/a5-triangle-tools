...
VnameVisitor<Void, AbstractSyntaxTree> {
		...
		public void printSummaryStats() {
			System.out.println("Total 'binary expressions' : " + binaryExpressionCount);
			System.out.println("Total 'if' commands : " + ifCommandCount);
			System.out.println("Total 'While' Commands : " + whileCommandCount);
		}
		//task 6a
		@Override
		public AbstractSyntaxTree visitLoopWhileCommand(loopWhileCommand ast, Void arg) {
		    ast.c1AST.visit(this, null);
		    ast.eAST.visit(this, null);
		    ast.c2AST.visit(this, null);
		    return null;
		}
