...
public final class Checker implements ActualParameterVisitor<FormalParameter, Void>,
                                      ...
                                      ExpressionVisitor<Void, TypeDenoter>,
                                      FormalParameterSequenceVisitor<Void, Void>, IdentifierVisitor<Void, Declaration>,
                                      LiteralVisitor<Void, TypeDenoter>, OperatorVisitor<Void, Declaration>,
    ...
    private void checkAndReportError(
            boolean condition, String message, Terminal spellingNode,
    ...
    private BinaryOperatorDeclaration declareStdBinaryOp(
            String op, TypeDenoter arg1Type, TypeDenoter arg2type,
    ...
    private void establishStdEnvironment() {
        ...
        StdEnvironment.ordDecl = declareStdFunc("ord",
                                                new SingleFormalParameterSequence(
                                                        new ConstFormalParameter(dummyI, StdEnvironment.charType, dummyPos),
                                                        dummyPos),
                                                StdEnvironment.integerType);
