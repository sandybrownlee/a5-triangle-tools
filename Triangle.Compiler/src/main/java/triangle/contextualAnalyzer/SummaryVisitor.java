...
public class SummaryVisitor implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
    ...
    public int binaryExpressionCounter = 0;
    public int ifCommandCounter = 0;
    public int whileCommandCounter = 0;

    public void printSummery(){
        System.out.println("Num of binary expressions: " + binaryExpressionCounter);
        System.out.println("Num of if commands: " + ifCommandCounter);
        System.out.println("Num of while commands: " + whileCommandCounter);
    }
