...
public class ExpressionStatistics implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
	...
	public AbstractSyntaxTree visitProgram(Program ast, Void arg) {
		ast.C.visit(this);
		System.out.println("There were " + charExpressionCount + " character expression nodes and " + intExpressionCount + " integer expression nodes");
		return null;
	}
