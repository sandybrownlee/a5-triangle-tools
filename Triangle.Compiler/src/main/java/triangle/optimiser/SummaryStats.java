...
public class SummaryStats implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
	...
	//Task 5.a counter for each instance of a character expression and integer expression
	private int charExpCount = 0;
	private int intExpCount = 0;
	
	//Task 5.a print the summary stats
	public void printSummaryStats() {
		System.out.println("There is a total of " + charExpCount + " character expressions.");
		System.out.println("There is a total of " + intExpCount + " integer expressions.");
	}
