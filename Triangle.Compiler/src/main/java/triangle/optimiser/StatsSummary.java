...
public class StatsSummary implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
    ...
    //Tallies for the final stats output. Set to private for encapsulation.
    private int binaryExpressionTally = 0;
    private int ifCommandTally = 0;
    private int whileCommandTally = 0;
    ...
    @Override
    public AbstractSyntaxTree visitNewLoopCommand(NewLoopCommand ast, Void unused) {
...
//	}
    ...
    //Getters to maintain encapsulation principles
    public int getBinaryExpressionCount() {
        return binaryExpressionTally;
    }

    public int getIfCommandCount() {
        return ifCommandTally;
    }

    public int getWhileCommandCount() {
        return whileCommandTally;
    }
