...
public class SummaryVisitor implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
    ...
    HashMap<String, Integer> visitorStats = new HashMap<>() {
        {
            put("Binary Expression", 0);
            put("If Command", 0);
            put("While Command", 0);
        }
    };
    ...
    /**
     * @param v - the key in the map to increment
     */
    public void incrementSummaryCounter(String v) {
        int e = visitorStats.get(v);
        e++;
        visitorStats.put(v, e);
    }

    /**
     * @return the string showing the visitor summary
     */
    public String getStats() {
        StringBuffer s = new StringBuffer();
        for (HashMap.Entry<String, Integer> e : visitorStats.entrySet()) {
    ...
    public AbstractSyntaxTree visitBinaryExpression(BinaryExpression ast, Void arg) {
        ...
        // increment counter
        incrementSummaryCounter("Binary Expression");
    ...
    public AbstractSyntaxTree visitIfCommand(IfCommand ast, Void arg) {
        ...
        // increment counter
        incrementSummaryCounter("If Command");
