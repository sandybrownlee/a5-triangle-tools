...
public class ExpressionCounter implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
	...
	private int charExpressionCount = 0;
	private int intExpressionCount = 0;


	public void printExpressionCounts() {
		System.out.println("Character Expression Count: " + charExpressionCount);
		System.out.println("Integer Expression Count: " + intExpressionCount);
	}
