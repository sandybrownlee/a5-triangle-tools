...
public class ExpressionCounter implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
    ...
    public AbstractSyntaxTree visitCharacterExpression(CharacterExpression ast, Void arg) {
        ast.CL.visit(this);
        characterCounter++; //adds 1 for each character expression
        return null;
    }
    ...
    public AbstractSyntaxTree visitIntegerExpression(IntegerExpression ast, Void arg) {
        integerCounter++; //adds to the counter at each integer experrsion visit
        return ast;
    }
...
//	}
    ...
    public void count(Program theAST) { // for displaying the character counter and integer counter
        theAST.visit(this);
        System.out.println("Character expressions: "+ characterCounter);
        System.out.println("Integer expressions: "+ integerCounter);
    }
}
