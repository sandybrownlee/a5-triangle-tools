...
public class Parser {
    ...
    Command parseSingleCommand() throws SyntaxError {
        ...
        switch (currentToken.kind) {
            ...
            //New token for question 4 that allows for { and makes it need }
            case Token.LCURLY:
                acceptIt();
                commandAST = parseCommand();
                accept(Token.RCURLY);
    ...
    Expression parsePrimaryExpression() throws SyntaxError {
        ...
        switch (currentToken.kind) {
            ...
            //Assigns record aggregate until a "}" is accepted. A new record
            //expression is then assigned to the expression abstract syntax tree
            case Token.LCURLY: {
                acceptIt();
