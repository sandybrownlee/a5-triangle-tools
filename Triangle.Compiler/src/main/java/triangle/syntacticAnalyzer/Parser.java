    ...
    Command parseSingleCommand() throws SyntaxError {
        ...
        switch (currentToken.kind) {
            ...
            case Token.IDENTIFIER: {
                ...
                } else { //task 3 start code

                    Vname vAST = parseRestOfVname(iAST);
                    Expression eAST;
                    if (currentToken.kind == Token.OPERATOR && currentToken.spelling.equals("**")) { //finds operator "**"
                        acceptIt();
                        eAST = new BinaryExpression(
                                new VnameExpression(vAST, commandPos),
                                new Operator("*", commandPos),
                                new IntegerExpression(new IntegerLiteral("2", commandPos), commandPos),
                                commandPos
                        );
                    } else {
